...
const Servicios = () => {
  ...
  return (
    <div className="bg-gray-50s">
      ...
      <section className="grid grid-cols-1 max-w-6xl mx-auto bg-sect_gray p-8 pt-16 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
        ...
        <article className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-in-out">
          ...
          <p className="text-justify text-gray-700 leading-relaxed">
            ...
            encargamos desde la toma de fotografías hasta la edición profesional
            para entregarte recuerdos inolvidables.
          </p>
        </article>
        ...
        <article className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-in-out">
          ...
          <p className="text-justify text-gray-700 leading-relaxed">
            ...
            avanzada, impresión de alta calidad y opciones de enmarcado para que
            tus fotos luzcan espectaculares.
          </p>
        </article>
        ...
        <article className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-in-out">
          ...
          <p className="text-justify text-gray-700 leading-relaxed">
            ...
            servicios de impresión, ampliación y enmarcado en diversos formatos
            y materiales, asegurando la máxima calidad y durabilidad para tus
            fotografías.
          </p>
        </article>
        ...
        <article className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ease-in-out">
          ...
          <p className="text-justify text-gray-700 leading-relaxed">
            Te guiamos en la planificación de tu proyecto fotográfico, desde la
            conceptualización hasta la entrega final. Ofrecemos consultoría
