...
<div className="relative">
  <div className="max-w-6xl mx-auto pt-5 px-4 sm:px-6 lg:px-8">
    <main>
      <article className="mb-8 lg:mb-20">
        <div className="relative h-[400px] md:h-[500px] lg:h-[600px]">
          ...
          <div className="absolute top-1/2 left-0 right-0 flex flex-col items-center justify-center transform -translate-y-1/2 z-20">
            ...
            <button className="transition hover:scale-105 bg-huellas_color font-bold text-white rounded-full px-6 py-2 text-sm sm:text-base">
        ...
        {/* Primera Sección */}
        <section className="flex flex-col lg:flex-row overflow-hidden"> {/* Apilamos en móviles, alineamos en horizontal en grandes, añadimos espacio */}
          <div className="w-full lg:w-1/2"> {/* Ocupa todo el ancho en móviles, la mitad en grandes */}
            <ImagenFront
          ...
          <div className="w-full lg:w-1/2"> {/* Ocupa todo el ancho en móviles, la mitad en grandes */}
            <CardTexto
              titulo={"Momentos Únicos"}
              slogan={"Buscamos el mejor momento para inmortalizarlo en fotografía."}
              texto={"Una mirada discreta, una sonrisa, una lágrima de emoción; tu celebración está llena de detalles especiales que logramos capturar."}
              bg={"bg-white"}
              textColor={"text-slate-500"}
            />
          </div>
        ...
        {/* Segunda Sección */}
        <section className="flex flex-col lg:flex-row-reverse overflow-hidden"> {/* Apilamos en móviles, invertimos en grandes, añadimos espacio */}
          <div className="w-full lg:w-1/2"> {/* Ocupa todo el ancho en móviles, la mitad en grandes */}
            <ImagenFront
          ...
          <div className="w-full lg:w-1/2 "> {/* Ocupa todo el ancho en móviles, la mitad en grandes */}
            <CardTexto
              titulo={"VIVE, SIENTE Y ABSORBE CADA INSTANTE"}
              slogan={"Todo lo que necesitas para tener los mejores recuerdos de ese día tan especial."}
              texto={"Por que el tiempo pasa, pero los recuerdos quedan"}
              bg={"bg-grayFotos"}
              textColor={"text-white"}
            />
      ...
      <div>
        <section className="py-8 bg-sect_gray"> {/* Añadimos padding vertical */}
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8"> {/* Centramos y añadimos padding horizontal adaptable */}
            <Cliente />
          </div>
        </section>
      </div>
      ...
      <footer>
        <div className="bg-gray-800 text-white py-4 text-center">
          <p className="text-sm">© {new Date().getFullYear()} Estudio Fotográfico Otra Dimensión. Holguín. Cuba</p>
        </div>
      </footer>
    </div>
  );
