...
routerTrabajadores.post("/trabajadores",authRequired,uploadTrabajador.single("imagenPerfil"),crearTrabajador);
routerTrabajadores.put("/trabajadores/:id",authRequired,uploadTrabajador.single("imagenPerfil"),actualizarTrabajador);
routerTrabajadores.delete("/trabajadores/:id",authRequired,eliminarTrabajador);
